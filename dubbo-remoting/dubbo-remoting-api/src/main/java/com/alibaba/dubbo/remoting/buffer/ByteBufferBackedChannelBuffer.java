...
/**
 * 该方法继承AbstractChannelBuffer，
 * 该类是基于 Java NIO中的ByteBuffer来实现相关的读写数据等操作。
 * <p>
 * 上述就是该类的属性和构造函数，可以看到它有一个ByteBuffer类型的实例，并且capacity是buffer的剩余容量。
 * <p>
 * 还有其他的方法比如getByte方法是从buffer中读取数据方法，setBytes方法是把数据写入buffer，
 * 它们都有很多重载方法，它们都是调用了ByteBuffer中的一些方法，
 * 如果对于Java NIO中的ByteBuffer方法，需要先了解一下Java NIO中的ByteBuffer。
 */
public class ByteBufferBackedChannelBuffer extends AbstractChannelBuffer {

    /**
     * Java NIO中的 ByteBuffer实例
     */
