...
public class Transporters {
    ...
    public static Server bind(URL url, ChannelHandler... handlers) throws RemotingException {
        ...
        // 获取自适应Transporter实例,并调用实例方法. getTransporter()方法获取的Transporter是在运行时动态创建的,
        // 类名为TransporterAdaptive,也就是自适应拓展类.TransporterAdaptive会在运行时根据传入的URL参数决定加载
        // 什么类型的Transporter,这里我们配置成了netty4的NettyTransporter
